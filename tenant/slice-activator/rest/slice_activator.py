...
def delete_slice():
    ...
    if(sro_response.status_code == 201 or sro_response.status_code == 200):
        logs.logger.info("Comunicação com spec_processor estabelecida e slice deletada")
